...
public class VertexFreqNoise : AudioSyncer {
    ...
    private IEnumerator MoveToScale(float _target)
    {
        ...
        while (_curr != _target)
        {
            ...
            rend.material.SetFloat("_Freq", _curr);
    ...
    public override void OnUpdate()
    {
        ...
        rend.material.SetFloat("_Freq", Mathf.Lerp(rend.material.GetFloat("_Freq"), restScale, restSmoothTime * Time.deltaTime)); ;
    }
