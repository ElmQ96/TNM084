...
public class FragmentNoise : AudioSyncer {
    ...
    void Update()
    {
        ...
        //Debug.Log(rend.material.GetFloat("_ClrAmnt"));
    }

     private IEnumerator MoveToScale(float _target)
     {
        //Get the current value of the material
        float _curr = rend.material.GetFloat("_ClrAmnt");
        ...
        float _timer = 0;
         ...
         while (_curr != _target)
         {
            ...
            rend.material.SetFloat("_ClrAmnt", _curr);
     ...
     public override void OnUpdate()
     {
        ...
        rend.material.SetFloat("_ClrAmnt", Mathf.Lerp(rend.material.GetFloat("_ClrAmnt"), restScale, restSmoothTime * Time.deltaTime));;
     }
